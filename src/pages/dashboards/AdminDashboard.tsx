...
import { Shield, Users, Settings, AlertTriangle, Ticket } from 'lucide-react';
    ...
    <BaseDashboard title="Tableau de bord Administrateur">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="space-y-4">
            {[
              { label: 'Gestion des utilisateurs', icon: Users, path: '/dashboard/admin/users' },
              { label: 'Configuration système', icon: Settings, path: '/dashboard/admin/settings' },
              { label: 'Gestion des permissions', icon: Shield, path: '/dashboard/admin/permissions' },
              { label: 'Gestion des lottos', icon: Ticket, path: '/dashboard/admin/lottos' },
            ].map((action, index) => (
              <Link
                key={index}
                to={action.path}
